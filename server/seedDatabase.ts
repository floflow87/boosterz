...
const autographeCards: AutoCard[] = [
  ...
  { id: 21, playerName: "Lorik Cana", teamName: "FC Nantes", numberings: ["/199"] },
  { id: 22, playerName: "Dimitri Payet", teamName: "Olympique de Marseille", numberings: ["/199", "/99", "/49", "/25", "/10", "/5", "/3", "/2"] },
  { id: 23, playerName: "Florian Thauvin", teamName: "Olympique de Marseille", numberings: ["/199"] },
  { id: 24, playerName: "Steve Mandanda", teamName: "Stade Rennais FC", numberings: ["/199"] },
  { id: 25, playerName: "Morgan Schneiderlin", teamName: "OGC Nice", numberings: ["/199"] },
  { id: 26, playerName: "Kasper Dolberg", teamName: "OGC Nice", numberings: ["/199"] },
