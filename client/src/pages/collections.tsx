...
export default function Collections() {
  ...
  // Professional loading screen for cards
  if (cardsLoading && activeTab === "cards") {
    return (
      <div className="min-h-screen bg-[hsl(216,46%,13%)] flex items-center justify-center">
        <div className="text-center">
          <div className="relative mb-8">
            {/* Animated card stack */}
            <div className="w-20 h-28 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg mx-auto relative">
              <div className="absolute inset-1 bg-gradient-to-br from-blue-500 to-purple-500 rounded-md animate-pulse"></div>
              <div className="absolute top-2 left-2 w-3 h-3 bg-yellow-400 rounded-full animate-ping"></div>
            </div>
            <div className="w-20 h-28 bg-gradient-to-br from-indigo-600 to-blue-600 rounded-lg mx-auto relative -mt-24 ml-2 opacity-80">
              <div className="absolute inset-1 bg-gradient-to-br from-indigo-500 to-blue-500 rounded-md animate-pulse" style={{ animationDelay: '0.2s' }}></div>
            </div>
            <div className="w-20 h-28 bg-gradient-to-br from-purple-600 to-pink-600 rounded-lg mx-auto relative -mt-24 ml-4 opacity-60">
              <div className="absolute inset-1 bg-gradient-to-br from-purple-500 to-pink-500 rounded-md animate-pulse" style={{ animationDelay: '0.4s' }}></div>
            </div>
          </div>
          <h3 className="text-xl font-bold text-white mb-2">Chargement des cartes</h3>
          <p className="text-gray-400 text-sm">Optimisation en cours avec cache intelligent...</p>
