...
export const users = pgTable("users", {
  ...
  canCreatePosts: boolean("can_create_posts").default(true).notNull(),
  canSendMessages: boolean("can_send_messages").default(true).notNull(),
  canManageCards: boolean("can_manage_cards").default(true).notNull(),
  canManageDecks: boolean("can_manage_decks").default(true).notNull(),
  canManageCollections: boolean("can_manage_collections").default(true).notNull(),
